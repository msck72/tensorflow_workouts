#here some tensor operations are not seperated as tf.function which slows down the operations
# modularizing some tensor operations as tf.function, improves the overall exection time
...
model = CustomizedModel(len(x_train[0]) * len(x_train[1]), [1024 , 256 , 10])
...
for epochs in range(EPOCHS):
    ...
    print(f"Epoch : {epochs} , loss = {train_loss.result()} , accuracy = {train_accuracy.result() * 100}")
